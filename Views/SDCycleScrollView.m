...
- (void)setImagesGroup:(NSArray *)imagesGroup
{
    ...
    if (!(imagesGroup.count>0)) {
        ...
        imagesGroup = @[[UIImage imageNamed:@"h1.jpg"],
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    id image  = self.imagesGroup[itemIndex];
    
    if ([image isKindOfClass:[NSString class]]) {
        [cell.imageView sd_setImageWithURL:[NSURL URLWithString:self.imagesGroup[itemIndex]]placeholderImage:nil options:SDWebImageRefreshCached];
