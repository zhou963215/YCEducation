...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [_nameLB mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.centerX.equalTo(wk.mas_centerX);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.nameLB.textColor = _textColor;
    cell.nameLB.font = [UIFont systemFontOfSize:_fontSize];
    cell.nameLB.text = _titles[indexPath.row];
...
- (void)setType:(YBPopupMenuType)type
{
    ...
    switch (type) {
        ...
        {
            _textColor = UICOLORRGB(0xa1a0a1);
            _contentColor = UICOLORRGB(0xffffff);
            _separatorColor = [UIColor lightGrayColor];
        }
            break;
