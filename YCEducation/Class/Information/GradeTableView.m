...
@implementation GradeTableView


+(instancetype)blog{
    
    return  [[GradeTableView alloc]init];
}
...
- (instancetype)init{
    ...
    if (self = [super init]) {
        ...
        self.paramter = @{@"campusId":@"1",@"fzType":@"3"};
...
//    
//    GroupHeaderView * view = [tableView dequeueReusableHeaderFooterViewWithIdentifier:@"header2"];
//    
...
//    
//    GroupSelectTableViewCell * cell = [tableView dequeueReusableCellWithIdentifier:@"cell2"];
