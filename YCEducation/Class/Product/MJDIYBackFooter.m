...
- (void)prepare
{
    ...
    label.textColor = UICOLORRGB(0xa0a0a0);
    ...
    // logo
    UIImageView *logo = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"z_up"]];
...
- (void)placeSubviews
{
    ...
    [self.label mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(wk.logo.mas_bottom).offset(12);
    ...
    [self.loading mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(wk).offset(100);
